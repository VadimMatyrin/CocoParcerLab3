...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 42; i <= 43; ++i) start[i] = 5;
		for (int i = 45; i <= 45; ++i) start[i] = 5;
		for (int i = 47; i <= 47; ++i) start[i] = 5;
		start[59] = 6; 
		start[40] = 13; 
		start[41] = 14; 
		start[123] = 15; 
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 3:
				if (ch <= '&' || ch >= '(' && ch <= 65535) {AddCh(); goto case 3;}
